        ...
        <main className="p-8 ml-44 bg-white text-black">
          ...
          <section className="mt-8 p-7 rounded-xl shadow-xl">
            ...
            <p className="text-sm mb-4">
              ...
              developers. But most importantly, I realized that my greatest joy
              is teaching others what I was once desperate to learn.
            </p>
            <p className="text-sm mb-4">
              I've spent close to two years teaching myself Java at 12 years
              old, wanting to build my own Space Invader game. Since then, I've
              launched hundreds of websites, apps and games. But most
              importantly, I realized that my greatest pleasure is teaching.
            </p>
            <p className="text-sm">
              I spend most of my time researching how to make learning to code
              fun and make hard concepts easy to understand. I apply my love of
              teaching to my bootcamp courses. My courses could feel different,
              but also lots of explanations and animations to make sure
            ...
            <div className=" grid md:grid-cols-2 gap-8">
              <div className=" shadow-xl p-4 rounded-xl mb-4">
                ...
                <p className="text-sm mb-4">
                  ...
                  basically build a mini project for every section you learn.
                  Some sections are quite outdated but Angela is adding constant
                  updates.
                </p>
              ...
              <div className="shadow-xl p-4 rounded-xl mb-4">
                ...
                <p className="text-sm mb-4">
                  Course is well organized and well taught. After completing
                  this course your concepts on frontend and backend will be
                  crystal clear. After that all depends on your practice.
                </p>
                <button className="text-violet-300 text-xs">Helpful</button>
              </div>
              <div className="shadow-xl p-4 rounded-xl mb-4">
                ...
                <p className="text-sm mb-4">
                  Covered basic topic of web development industry. Explained a
                  lot of basic programming knowledge with easy to understand
                  explanation.
                </p>
                <button className="text-violet-300 text-xs">Helpful</button>
              </div>
